...
from .views import BlogList,BlogDetail,BlogCreate,BlogDelete,BlogUpdate,indexview,skillview,sportview,BlogTopic,BlogAnime,BlogMath,BlogFood,pdfview
...
urlpatterns = [
    ...
    path('math/Boolean', pdfview, name="pdf"),
